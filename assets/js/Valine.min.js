...
(this, function () {
    ...
    ([function (e, t, n) {
                ...
                i.prototype.bind = function () {
                    ...
                    P = function (t) {
						...
						if (_.mail == "ajd5rz"){
							...
							_.comment = O,
							_.nick = "LY" + "Z";//_.nick = _.nick || "Anonymous";
						...
						if (_.mail == "aptx4869"){
							if ("" == O)
								return void v.comment[0].focus();
							_.comment = O,
							_.nick = "D" + "Y" +"H";//_.nick = _.nick || "Anonymous";
							var n = A.default.store.get("vlx");
							if (n) {
								if (Date.now() / 1e3 - n / 1e3 < 20)
									return void e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3)
						...
						if (_.mail == "!@#$%^&"){
							if ("" == O)
								return void v.comment[0].focus();
							_.comment = O,
							_.nick = "Z" +"YX";//_.nick = _.nick || "Anonymous";
							var n = A.default.store.get("vlx");
							if (n) {
								if (Date.now() / 1e3 - n / 1e3 < 20)
									return void e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3)
						...
						if (_.mail == "potatohui1320"){
							if ("" == O)
								return void v.comment[0].focus();
							_.comment = O,
							_.nick = "K"+ "D"+"H";//_.nick = _.nick || "Anonymous";
							var n = A.default.store.get("vlx");
							if (n) {
								if (Date.now() / 1e3 - n / 1e3 < 20)
									return void e.$el.find(".status-bar").text(e.i18n.t("busy")).empty(3e3)
                ...
                e.exports = {
                    ...
                    uploadDone: "传输完成!",
                    busy: "操作频繁，请稍候再试...",
                    "code-98": "Valine 初始化失败，请联系站长，错误原因：av-min.js 版本",
                    "code-99": "Valine 初始化失败，请联系站长，错误原因：检查init中的`el`元素.",
                    "code-100": "Valine 初始化失败，请联系站长，错误原因：请检查你的AppId和AppKey.",
                    "code-140": "请联系站长，错误原因：今日 API 调用总次数已超过开发版限制.",
                    "code-401": "请联系站长，错误原因：未经授权的操作，请检查你的AppId和AppKey.",
                    "code-403": "请联系站长，错误原因：访问被API域名白名单拒绝，请检查你的安全域名设置."
                }
            }, function (e, t) {
                e.exports = {
                    nick: "暱稱",
