...
Swiper.prototype.plugins.progress = function (a) {
    function b() {
        for (var b = 0; b < a.slides.length; b++) {
            ...
            (c.progressSlideSize = e ? a.h.getWidth(c) : a.h.getHeight(c)),
                (c.progressSlideOffset =
                    "offsetLeft" in c
                        ? e
                            ? c.offsetLeft
                            : c.offsetTop
                        : e
                        ? c.getOffset().left - a.h.getOffset(a.container).left
                        : c.getOffset().top - a.h.getOffset(a.container).top);
        }
        d = e
            ? a.h.getWidth(a.wrapper) + a.wrapperLeft + a.wrapperRight - a.width
            : a.h.getHeight(a.wrapper) +
              a.wrapperTop +
              a.wrapperBottom -
              a.height;
    }
    function c(b) {
        ...
        (a.progress = e ? -b.x / d : -b.y / d),
            a.params.onProgressChange &&
                a.fireCallback(a.params.onProgressChange, a);
    }
    var d,
