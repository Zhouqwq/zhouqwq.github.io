        ...
        return (
            ...
            (e.prototype._setActive = function (t) {
                ...
                return (
                    ...
                    $(".slidesjs-pagination li:eq(" + e + ") a", i).addClass(
                        "active"
                    )
                );
            }),
                ...
                return (
                    ...
                    (n.position().left > 0.1 * this.options.width &&
                        ...
                        : ((s = this.data.vendorPrefix),
                          ...
                          (n[0].style[e] =
                              0.85 * this.options.effect.slide.speed + "ms")),
                    n.on(
            ...
            (e.prototype.play = function (t) {
                ...
                return (
                    ...
                    this.options.play.swap)
                        ? ($(".slidesjs-play", i).hide(),
                          $(".slidesjs-stop", i).show())
                        : void 0
                );
            }),
            (e.prototype.stop = function (t) {
                ...
                return (
                    ...
                    this.options.play.swap
                        ? ($(".slidesjs-stop", i).hide(),
                          $(".slidesjs-play", i).show())
                        : void 0
                );
            }),
                ...
                return (
                    ...
                    this.data.animating || t === this.data.current + 1
                        ...
                        : ($.data(this, "animating", !0),
                          ...
                          t
                              ? ((t -= 1), (a = t > e ? 1 : -1), (s = t))
                              : ((a = "next" === this.data.direction ? 1 : -1),
                                (s = e + a)),
