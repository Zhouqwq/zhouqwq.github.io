    ...
    return (
      ...
      (e.prototype.init = function () {
        ...
        return (
          ...
          $.data(
            this,
            "total",
            i.children().not(".slidesjs-navigation", i).length
          ),
          ...
          (i.slidesContainer = i
            .children()
            .not(".slidesjs-navigation", i)
            .wrapAll("<div class='slidesjs-container'>", i)
            .parent()
            .css({ overflow: "hidden", position: "relative" })),
          $(".slidesjs-container", i)
            .wrapInner("<div class='slidesjs-control'>", i)
            .children(),
          ...
          this.data.touch &&
            ($(".slidesjs-control", i).on("touchstart", function (t) {
          ...
          this.options.play.active &&
            ...
            this.options.play.swap && o.css({ display: "none" })),
          this.options.pagination.active &&
            ((s = $("<ul>", {
              class: "slidesjs-pagination",
            }).appendTo(i)),
            $.each(new Array(this.data.total), function (t) {
              var i, e;
              return (
                (i = $("<li>", {
                ...
                e.click(function (t) {
                  return (
                    ...
                    d.stop(!0),
                    d.goto(
                      1 * $(t.currentTarget).attr("data-slidesjs-item") + 1
                    )
                  );
                })
              );
      ...
      (e.prototype.goto = function (t) {
        ...
        if (
          ((i = $(this.element)),
          (this.data = $.data(this)),
          void 0 === e && (e = this.options.pagination.effect),
          t > this.data.total ? (t = this.data.total) : 1 > t && (t = 1),
          "number" == typeof t)
        )
          return "fade" === e ? this._fade(t) : this._slide(t);
        if ("string" == typeof t) {
          if ("first" === t)
            return "fade" === e ? this._fade(0) : this._slide(0);
          if ("last" === t)
            return "fade" === e
      ...
      (e.prototype._touchend = function (t) {
        ...
        return (
          ...
          n.position().left > 0.5 * this.options.width ||
          (n.position().left > 0.1 * this.options.width &&
            Number(new Date()) - this.data.touchtimer < 250)
            ? ($.data(this, "direction", "previous"), this._slide())
            : n.position().left < -(0.5 * this.options.width) ||
              (n.position().left < -(0.1 * this.options.width) &&
                Number(new Date()) - this.data.touchtimer < 250)
            ? ($.data(this, "direction", "next"), this._slide())
            : ((s = this.data.vendorPrefix),
              (d = s + "Transform"),
              (e = s + "TransitionDuration"),
              (a = s + "TransitionTimingFunction"),
              (n[0].style[d] = "translateX(0px)"),
              (n[0].style[e] = 0.85 * this.options.effect.slide.speed + "ms")),
          n.on(
            "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",
            function () {
              return (
                (s = r.data.vendorPrefix),
                (d = s + "Transform"),
                (e = s + "TransitionDuration"),
                (a = s + "TransitionTimingFunction"),
                (n[0].style[d] = ""),
      ...
      (e.prototype._touchmove = function (t) {
        ...
        return (
          ...
          $.data(
            this,
            "scrolling",
            Math.abs(n.pageX - this.data.touchstartx) <
              Math.abs(n.pageY - this.data.touchstarty)
          ),
          this.data.animating ||
            this.data.scrolling ||
            (t.preventDefault(),
            this._setuptouch(),
            (s[0].style[a] =
              "translateX(" + (n.pageX - this.data.touchstartx) + "px)")),
          t.stopPropagation()
        );
      }),
        ...
        return (
          ...
          this.options.play.pauseOnHover &&
            ...
            s.bind("mouseleave", function () {
              return n.options.play.restartDelay
                ? $.data(
                    n,
                    "restartDelay",
                    setTimeout(function () {
                      return n.play(!0);
                    }, n.options.play.restartDelay)
                  )
                : n.play();
            })),
          $.data(this, "playing", !0),
          $(".slidesjs-play", i).addClass("slidesjs-playing"),
          this.options.play.swap)
            ? ($(".slidesjs-play", i).hide(), $(".slidesjs-stop", i).show())
            : void 0
        );
      }),
      (e.prototype.stop = function (t) {
        ...
        return (
          ...
          this.options.play.pauseOnHover &&
            t &&
            $(".slidesjs-container", i).unbind(),
          $.data(this, "playInterval", null),
          $.data(this, "playing", !1),
          $(".slidesjs-play", i).removeClass("slidesjs-playing"),
          this.options.play.swap
            ? ($(".slidesjs-stop", i).hide(), $(".slidesjs-play", i).show())
            : void 0
        );
      }),
      (e.prototype._slide = function (t) {
        ...
        return (
          ...
          this.data.animating || t === this.data.current + 1
            ? void 0
            : ($.data(this, "animating", !0),
              (e = this.data.current),
              t > -1
                ? ((t -= 1),
                  (h = t > e ? 1 : -1),
                  (s = t > e ? -this.options.width : this.options.width),
                  (a = t))
                : ((h = "next" === this.data.direction ? 1 : -1),
                  (s =
                    "next" === this.data.direction
                      ? -this.options.width
                      : this.options.width),
                  (a = e + h)),
              -1 === a && (a = this.data.total - 1),
              a === this.data.total && (a = 0),
              this._setActive(a),
              (d = $(".slidesjs-control", i)),
              t > -1 &&
                d
                  .children(":not(:eq(" + e + "))")
                  .css({ display: "none", left: 0, zIndex: 0 }),
              ...
              this.options.callback.start(e + 1),
              this.data.vendorPrefix
                ? ((o = this.data.vendorPrefix),
                  (l = o + "Transform"),
                  (n = o + "TransitionDuration"),
                  (r = o + "TransitionTimingFunction"),
                  (d[0].style[l] = "translateX(" + s + "px)"),
                  (d[0].style[n] = this.options.effect.slide.speed + "ms"),
                  d.on(
                    "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",
                    function () {
                      return (
        ...
        return (
          ...
          this.data.animating || t === this.data.current + 1
            ...
            : ($.data(this, "animating", !0),
              ...
              t
                ? ((t -= 1), (a = t > e ? 1 : -1), (s = t))
                : ((a = "next" === this.data.direction ? 1 : -1), (s = e + a)),
                    ...
                    .fadeOut(this.options.effect.fade.speed, function () {
                      return (
                        n
                          .children(":eq(" + s + ")")
                          .stop()
                          .fadeIn(o.options.effect.fade.speed, function () {
      ...
      ($.fn[n] = function (t) {
        return this.each(function () {
          return $.data(this, "plugin_" + n)
            ? void 0
            : $.data(this, "plugin_" + n, new e(this, t));
        });
      })
    );
